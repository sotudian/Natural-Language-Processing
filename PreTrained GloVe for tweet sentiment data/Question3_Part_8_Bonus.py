...
output_size = 1
embedding_dim = 100   # Best Embedding Dim based on part 6
hidden_dim = 128      # Best Hidden size based on part 6
n_layers = 2
epochs = 2
clip = 5
lr=0.005
...
if Want_To_Train_NN == 1:
    ...
    for i in range(epochs):
        ...
        for inputs, labels in train_loader:
            ...
            optimizer.step()
    torch.save(model.state_dict(), './Network_Q3_P8.pt')
else:
    model.load_state_dict(torch.load('./Network_Q3_P8.pt')) #Loading the model
